...
public enum PlayerRenderHandler {
    ...
    private void handleRenderHand_LowestCancelled(RenderHandEvent event) {
        restoreItems(cache.getUnchecked(LogicalSidedProvider.INSTANCE.<Minecraft>get(LogicalSide.CLIENT).player));
    }
    ...
    public void registerEvents() {
        ...
        MinecraftForge.EVENT_BUS.addListener(EventPriority.LOWEST, true, this::handleRenderHand_LowestCancelled);
